...
import GridGroupComponent from "@/components/propios/GridGroupComponent.vue";
import DetalleDato from "@/components/propios/DetalleDato.vue";
import ReporteComprasView from "@/views/ReporteComprasView.vue";
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          name: "oficiales",
          path: "oficiales",
          component: OficialesView
        },

        {
          path: "estadogestion",
          name: "estadogestion",
          component: EstadoGestionView
        },
        ...
        {
          path: "asignaciondatos",
          name: "asignaciondatos",
          component: AsignacionDatosView
        },
...

        {
          ...
          name: "detallereporte",
          props: true,
          component: DetalleReporteView
        },

        {
          path: "reporteasignaciones",
          name: "reporteasignaciones",
          component: ReporteAsignacionView
        },
...

        {
          ...
          children: [
            ...
            },
            {
              ...
              component: () =>
                import(
                  "../components/statistics/progress-bars/ProgressBars.vue"
                ),
              meta: {
                wikiLink:
