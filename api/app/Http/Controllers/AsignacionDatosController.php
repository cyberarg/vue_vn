...
class AsignacionDatosController extends Controller
{
    ...
    public function asginarDatos(Request $request){
        ...
        foreach ($arrObj as $dato) {
            ...
            $res[] = DB::select("CALL hnweb_subiteasignacion(".$asignaOficial.", '".$js->Grupo."', ".$js->Orden.", ".$codOficial.", ".$codSupervisor.");");
        // DB::select("CALL hnweb_subiteasignacion(p_ASIGNAOFICIAL, P_GRUPO, P_ORDEN, P_OFICIAL, P_SUPERVISOR);");
        }
        return $str;
    ...
    public function pasarASinGestionar(Request $request){
        ...
        foreach ($arrObj as $dato) {
            ...
            $str[] = "CALL hnweb_subitepasarasingestionar('".$js->Grupo."', ".$js->Orden.");";
            $res[] = DB::select("CALL hnweb_subitepasarasingestionar('".$js->Grupo."', ".$js->Orden.");");
