...
*/
    ...
    public function grabarHN(Request $request){
        ...
        .$request->MontoCobroEstimado.", NULL, NULL, ".$request->HaberNetoSubite.", ".$request->HaberNetoOriginal.", NULL, '".$request->Login."', ".$request->NroTransferencia.", 0, ".$request->ComproGiama.", ".$request->TIRSpot.");");
